...
class BaseDailyDetailScreen extends StatelessWidget {
  static const routeName = '/base-daily-detail';

  const BaseDailyDetailScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final task = ModalRoute.of(context)!.settings.arguments as BaseTaskModel;
    final prov = context.read<BaseDailyProvider>();
