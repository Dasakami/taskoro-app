class UserModel {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    return UserModel(
      ...
      experienceNeeded: json['experience_needed'] ?? 100,
      coins: json['coins'] ?? 0,
      gems: json['gems'] ?? 0,
      ...
      medals: json['medals'] ?? const [],
      characterClasses: json['character_classes'] ?? const [],
  ...
  UserModel copyWith({
    ...
    String? equippedAvatarFrameColor,
    ...
    return UserModel(
      ...
      equippedAvatarFrameColor:
          equippedAvatarFrameColor ?? this.equippedAvatarFrameColor,
